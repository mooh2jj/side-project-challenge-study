package com.study.sidejavachallenge.domain.student.controller;

import com.study.sidejavachallenge.domain.student.dto.request.SearchRequestDto;
import com.study.sidejavachallenge.domain.student.dto.request.LottoRequestDto;
...
import com.study.sidejavachallenge.domain.student.service.StudentService;
...
//        String result = "";
    ...
    // 로또 생성기
    @PostMapping("/test4")
    public List<Integer> test4(@Valid @RequestBody LottoRequestDto request) {
